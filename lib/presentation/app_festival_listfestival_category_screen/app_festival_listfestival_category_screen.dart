...
class AppFestivalListfestivalCategoryScreen
    extends GetWidget<AppFestivalListfestivalCategoryController> {
  @override
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Row(children: [
                                                                          ...
                                                                          Container(
                                                                              ...
                                                                              decoration: AppDecoration.txtOutlineRed900.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder20),
                                                                              child: Text("msg_l_h_i_truy_n_th_ng2".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFProMedium16Red900.copyWith(height: 1.25)))
                                                                        ])))
                                                              ])),
                                                      Container(
                                                          width:
