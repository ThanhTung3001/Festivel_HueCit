import '../app_home_page/widgets/listanh_four_item_widget.dart';
import '../app_home_page/widgets/listeightytwo_item_widget.dart';
import '../app_home_page/widgets/listthirtyone_item_widget.dart';
...
class AppHomePage extends StatelessWidget {
  AppHomeController controller = Get.put(AppHomeController(AppHomeModel().obs));
                            ...
                            children: [
                                      ...
                                      child: Obx(() => ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ListthirtyoneItemModel model =
                                                controller.appHomeModelObj.value
                                                        .listthirtyoneItemList[
                                                    index];
                              ...
                              Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.appHomeModelObj
                                          .value.listeightytwoItemList.length,
                                      itemBuilder: (context, index) {
                              ...
                              Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.appHomeModelObj
                                          .value.listanhFourItemList.length,
                                      itemBuilder: (context, index) {
