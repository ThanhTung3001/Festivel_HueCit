import '../app_news_huenews_details_one_screen/widgets/listanh3_item_widget.dart';
...
class AppNewsHuenewsDetailsOneScreen
    extends GetWidget<AppNewsHuenewsDetailsOneController> {
  @override
                                        ...
                                        Padding(
                                            ...
                                            child: Obx(() => ListView.builder(
                                                ...
                                                itemCount: controller
                                                    .appNewsHuenewsDetailsOneModelObj
                                                    .value
                                                    .listanh3ItemList
                                                    .length,
                                                itemBuilder: (context, index) {
                                                  Listanh3ItemModel model = controller
                                                      .appNewsHuenewsDetailsOneModelObj
                                                      .value
                                                      .listanh3ItemList[index];
                                                  return Listanh3ItemWidget(
                                                      model);
                                                })))
                                      ]))))
                    ]))));
