...
class Listthirtyone2ItemWidget extends StatelessWidget {
  Listthirtyone2ItemWidget(this.listthirtyone2ItemModelObj, {this.onTapCard});

  Listthirtyone2ItemModel listthirtyone2ItemModelObj;

  var controller = Get.find<AppNewsComingfestivalController>();
