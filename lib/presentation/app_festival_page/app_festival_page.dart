import '../app_festival_page/widgets/listanh_four1_item_widget.dart';
import '../app_festival_page/widgets/listeightytwo1_item_widget.dart';
import 'controller/app_festival_controller.dart';
import 'models/app_festival_model.dart';
...
class AppFestivalPage extends StatelessWidget {
  AppFestivalController controller =
      Get.put(AppFestivalController(AppFestivalModel().obs));
                            ...
                            children: [
                              ...
                              Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.appFestivalModelObj
                                          .value.listeightytwo1ItemList.length,
                                      itemBuilder: (context, index) {
                                        Listeightytwo1ItemModel model =
                                            controller.appFestivalModelObj.value
  ...
  onTapTintuc() {
    Get.toNamed(AppRoutes.appFestivalListfestivalDetailsScreen);
    Get.toNamed(AppRoutes.appFestivalListfestivalDetailsScreen);
  }

  onTapLoaihinh() {
    Get.toNamed(
        AppRoutes.appFestivalListfestivalCategoryTraditionalfestivalScreen);
  }

  onTapTxtXemthm() {
    Get.toNamed(AppRoutes.appFestivalTypicalfestivalScreen);
  }

  onTapTxtXemthm1() {
    Get.toNamed(AppRoutes.appFestivalListfestivalCategoryScreen);
  }
